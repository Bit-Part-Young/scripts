...
#------------------------- 构建 HCP {11-21} 孪晶模型 --------------------------
function twin_11_21_generation() {
  ...
  atomsk --create hcp ${a} ${c} ${symbol} orient "[1-100]" "[11-26]" "[11-21]" -duplicate ${dup_x} ${dup_y} ${dup_z2} -sort z up -wrap -ow vasp
  ...
  mv POSCAR twin_11_21_${symbol}_original.vasp

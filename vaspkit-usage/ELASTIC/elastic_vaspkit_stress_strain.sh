...
#-------------------------------- 应力-应变法，使用 vaspkit 生成应变构型及输入文件 --------------------------------
function elastic_vaspkit_stress_strain() {
...
get_help() {
  ...
  echo -e "\nGenerate elastic constant calculation input files (stress-strain method; VASP + vaspkit)."
